// src/app/admin/categories/services/edit/[id]/page.tsx
"use client";
...
export default function EditServiceCategoryPage({ params }: { params: { id: string } }) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast.success("Kategori jasa berhasil diupdate");
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-2xl font-bold">Edit Kategori Jasa</h1>
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-green-600 dark:text-green-400">
              <span className="font-medium">Total Jasa:</span> {category._count.services}
            </p>
          ...
          {category._count.services > 0 && (
            <div className="text-xs text-amber-600 dark:text-amber-400">
              ⚠️ Kategori ini memiliki jasa terkait
            </div>
          )}
        </div>
      </div>
