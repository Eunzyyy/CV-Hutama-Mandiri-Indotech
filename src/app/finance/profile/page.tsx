//src/app/finance/profile/page.tsx
"use client";
...
export default function FinanceProfilePage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold">Profil Finance</h1>
        <p className="text-gray-500 dark:text-gray-400">
          Kelola informasi profil dan data karyawan finance
        </p>
      </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div className="text-center">
              ...
              <div className="flex justify-center mb-4">
                <span className="px-3 py-1 bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-400 text-sm font-medium rounded-full flex items-center">
                  <Shield size={14} className="mr-1" />
                  {profile?.role === "FINANCE" ? "Finance Staff" : 
                   profile?.role === "ADMIN" ? "Finance Admin" : 
                   "Finance Manager"}
                </span>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-bold">Informasi Karyawan</h3>
                {!isEditing ? (
                  <button
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    >
                      ...
                      <option value="Senior Finance">Senior Finance</option>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 dark:text-white">{profile?.department || "Finance"}</p>
                  )}
                </div>
